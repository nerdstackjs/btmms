...
func main() {
	...
	router.Handle("/api/access/permissions/{id}", controllers.UpdateAccessPermissionController).Methods("Put")
	router.Handle("/api/users", controllers.GetAllUserController).Methods("GET")
